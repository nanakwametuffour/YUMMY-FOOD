      ...
      <div className="w-full max-w-6xl mx-auto p-3 flex justify-between items-center">
        <div className="flex justify-center items-center gap-2">
          <FiAlignCenter
            ...
            className="text-4xl font-semibold active:scale-105 cursor-pointer"
          />
          <Link to={"/"}>
            <div className="flex justify-center items-center">
              <h1 className="text-red-600 text-sm lg:text-2xl font-semibold">
                YUMMY
              </h1>
              <img
                src={img}
        ...
        {/* <div className=" flex  w-auto justify-center border p-2 rounded-lg">
          <input
            type="text"
            className="w-24 sm:w-64 focus:outline-none bg-transparent placeholder:text-gray"
            placeholder="Search meal.."
          />
        </div> */}
        <div
          onClick={() => dispatch(setCartOpen())}
          className="  relative active:scale-105 cursor-pointer"
        >
